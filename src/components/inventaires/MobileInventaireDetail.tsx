            ...
            {!inventaire.financesCalcules ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* CMV */}
                  <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border border-orange-200 dark:border-orange-800 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
