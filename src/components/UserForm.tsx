          ...
          <div className="flex items-center gap-3 flex-1 min-w-0 pr-12">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-base sm:text-lg font-bold text-foreground">
                <span className="md:hidden">{mode === 'edit' ? 'Modifier' : 'Utilisateur'}</span>
                <span className="hidden md:inline">{mode === 'edit' ? 'Modifier l\'Utilisateur' : 'Nouvel Utilisateur'}</span>
              </h2>
          ...
          <div className="relative space-y-3">
            ...
            <div>
              ...
              >
                ...
                {roles
                  .filter(role => role.actif || (mode === 'edit' && role.id === (initialData?.roleId || initialData?.role?.id)))
                  .map(role => (
